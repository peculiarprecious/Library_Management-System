...
while (isRunning)
{
    ...
    switch (userChoice)
    {
        ...
        case 5:
            //Borrow Book
            BorrowBook(borrowHistory, users, books);
            break;
        case 6:
            //View borrow history
            borrowedHistory(borrowHistory, users, books);
            break;
        case 7:
            //Return book
            ReturnBook(borrowHistory, users, books);

            break;
        case 8:
            //Serach book ny author or title
            SearchBookByTitleOrAuthor(books);
...
//View All Books
static void AllBooks(List<Book> books)
{
     Console.WriteLine("\n--- LIBRARY COLLECTION ---");
...
//Add user
static void AddUser(List<LibraryUser> users)
{
     Console.WriteLine("\n--- Add New User ---");
...
//View users
static void AllUsers(List<LibraryUser> users)
{
     Console.WriteLine("\n--- View all Users ---");
            if (users.Count == 0)
            {
...
//Borrow Book
static void BorrowBook(List<BorrowRecord> borrowHistory, List<LibraryUser> users, List<Book> books)
{
    Console.WriteLine("\n--- Borrow Book ---");
...
static void borrowedHistory(List<BorrowRecord> borrowHistory, List<LibraryUser> users, List<Book> books)
{
    Console.WriteLine("\n--- Borrow History ---");
...
//Return a Book
static void ReturnBook(List<BorrowRecord> borrowHistory, List<LibraryUser> users, List<Book> books)
{
    Console.WriteLine("\n--- Return Book ---");
...
static void SearchBookByTitleOrAuthor(List<Book> books)
{
...
// Search User by Name
static void SearchUserByName(List<LibraryUser> users)
{
    Console.WriteLine("\n--- Search User by Name ---");
    ...
    {
        Console.WriteLine("Search Field cannot be empty");
        return;
    }
    ...
    if (userName1 != null)
    {
        ...
        Console.WriteLine($"ID: {userName1.UserId} | Name: {userName1.Name} | Email: {userName1.Email}");
    }
    else
    {
